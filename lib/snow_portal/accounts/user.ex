defmodule SnowPortal.Accounts.User do
  ...
  @role_values ~w/USER ADMIN EXECUTIVE/a
  ...
  schema "users" do
    ...
    has_many :ticket_history, TicketHistory,
      on_replace: :delete_if_exists,
      on_delete: :delete_all
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique([:email, :user_name], SnowPortal.Repo)
  ...
  """
  def valid_password?(%SnowPortal.Accounts.User{hashed_password: hashed_password}, password)
